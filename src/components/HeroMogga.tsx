...
export default function HeroMogga() {
  ...
  const CA = '0x0000000'; // подставь реальный контракт
    ...
    <section id="home" className={styles.hero} aria-label="Mogga hero">
      ...
      <div className={styles.panel}>
        ...
        <p className={styles.subtitle}>
          Mogga has no whitepaper — he ate it.
          Mogga has no plan — but he found a roadmap carved on his cave wall.
          So now he just follows the instructions.
        </p>
